...
// Set page title
$page_title = 'Imperio Radio - Skillet';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main>
    <!-- Artist heading -->
    <h1>Skillet - Tracks</h1>
    <h2>Chronicles of the Malpais' Legion</h2>
        ...
        <tbody>
            ...
            foreach ($tracks as $track) {
                ...
                <tr class="track-row" 
                    ...
                    <td class="genre"><?php echo isset($track['genre']) ? $track['genre'] : 'Rock'; ?></td>
                </tr>
                <?php
            }
            ?>
