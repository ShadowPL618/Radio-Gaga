...
// Set page title
$page_title = 'Imperio Radio - Sabaton';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main>
    <!-- Artist heading -->
    <h1>Sabaton - Tracks</h1>
    <h2>Chronicles of the Lanius' Legion</h2>
        ...
        <tbody>
            ...
            foreach ($tracks as $track) {
                ...
                <tr class="track-row" 
                    ...
                    <td class="genre"><?php echo isset($track['genre']) ? $track['genre'] : 'Metal'; ?></td>
                </tr>
                <?php
            }
            ?>
